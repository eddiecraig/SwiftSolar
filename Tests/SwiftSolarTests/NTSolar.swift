...
class NTSolar {
    ...
    class func sunRiseAndSet(forDate: Date,
        ...
        guard let year = comp.year,
            ...
            Logger.ntSolar.error("Failed to find date components.")
            return nil
        }
        ...
        if code != .RiseAndSet {
            Logger.ntSolar.error("Failed to find rise and set.")
            return nil
        }
    ...
    /// - Returns: Day number
    class func daylen(year: Int, month: Int, day: Int, lon: Double, lat: Double,
    ...
    class func sunpos(d: Double) -> (lon: Double, r: Double ) {
        /******************************************************/
    ...
    class func sun_RA_dec( d: Double ) -> (RA: Double, dec: Double, r: Double ) {
        /******************************************************/
    ...
    /*******************************************************************/
    class func revolution( x: Double ) -> Double {
        /*****************************************/
    ...
    class func rev180(x: Double ) -> Double {
        /*********************************************/
    ...
    /**                                                                 */
    /********************************************************************/
    class func GMST0( d: Double ) -> Double {
        var sidtim0: Double
...
extension Logger {
    ...
    static let ntSolar = Logger(subsystem: Bundle.main.bundleIdentifier ?? "foo", category: "NTSolar")
}
